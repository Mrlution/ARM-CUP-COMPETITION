...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ov5640_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mig_7series
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = ov5640_mig_7series_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = ov5640_LPR_PROJ_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = char_recongize_5thing
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ov5640_LPR_PROJ_char_recgonize_char_recongize_5thing_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = send_line_data
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ov5640_LPR_PROJ_char_recgonize_send_line_data_0
END
