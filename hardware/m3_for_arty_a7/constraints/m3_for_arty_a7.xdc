...
set_input_delay  -clock [get_clocks SWCLK] -add_delay 5.0 [get_ports TDI]
set_input_delay  -clock [get_clocks SWCLK] -add_delay 5.0 [get_ports nTRST]
set_output_delay -clock [get_clocks SWCLK] -add_delay 5.0 [get_ports TDO*]
