...
HD_PWD='v:/hardware/m3_for_arty_a7/m3_for_arty_a7/m3_for_arty_a7.tmp/vertical_projection8_v1_0_project/Vertical_Projection8_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vertical_Projection8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vertical_Projection8.tcl
