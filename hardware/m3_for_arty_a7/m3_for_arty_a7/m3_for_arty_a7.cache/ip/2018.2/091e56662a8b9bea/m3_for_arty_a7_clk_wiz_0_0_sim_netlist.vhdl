...
-- Date        : Tue May 28 15:05:28 2019
-- Host        : DESKTOP-0PTRBG6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ m3_for_arty_a7_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : m3_for_arty_a7_clk_wiz_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_m3_for_arty_a7_clk_wiz_0_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_m3_for_arty_a7_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_m3_for_arty_a7_clk_wiz_0_0_clk_wiz is
  signal clk_in1_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_m3_for_arty_a7_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out2_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_m3_for_arty_a7_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out3_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_m3_for_arty_a7_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out4_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_m3_for_arty_a7_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out5_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_m3_for_arty_a7_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clkfbout_buf_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_m3_for_arty_a7_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_m3_for_arty_a7_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out2_m3_for_arty_a7_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out2,
...
clkout3_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg3(7),
      CE1 => '0',
      I0 => clk_out3_m3_for_arty_a7_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out3,
...
clkout4_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg4(7),
      CE1 => '0',
      I0 => clk_out4_m3_for_arty_a7_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out4,
...
clkout5_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg5(7),
      CE1 => '0',
      I0 => clk_out5_m3_for_arty_a7_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out5,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_m3_for_arty_a7_clk_wiz_0_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_m3_for_arty_a7_clk_wiz_0_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out3_m3_for_arty_a7_clk_wiz_0_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg3(0),
      R => '0'
...
\seq_reg4_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out4_m3_for_arty_a7_clk_wiz_0_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg4(0),
      R => '0'
...
\seq_reg5_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out5_m3_for_arty_a7_clk_wiz_0_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg5(0),
      R => '0'
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_m3_for_arty_a7_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
